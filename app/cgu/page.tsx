  ...
  return (
    <main style={{ maxWidth: "640px", margin: "0 auto", padding: "60px 24px", fontFamily: "DM Sans, sans-serif", color: "#1A1210" }}>
      ...
      {[
        ...
        { title: "4. Téfi ne remplace pas un professionnel", content: "Téfi est un compagnon stratégique. Les suggestions de Téfi ne constituent en aucun cas des conseils juridiques, fiscaux, médicaux ou financiers. Pour toute décision importante, consultez un professionnel qualifié." },
        ...
        { title: "6. Limitation de responsabilité", content: "Duleme & Cie fait son possible pour maintenir FIRMAMENT disponible. En cas d'interruption, notre responsabilité est limitée à la période d'indisponibilité. Nous ne sommes pas responsables des décisions prises sur la base des suggestions de Téfi." },
